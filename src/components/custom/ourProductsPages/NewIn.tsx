...
const NewIn = () => {
  const [newArrivals, setNewArrivals] = useState<LatestProductsType[]>([]);
  ...
  return (
    <TabsContent value="new" className="flex flex-col gap-y-6 items-center">
      <SubTitle>Fresh arrivals just in for you.</SubTitle>
      <ProductGrid rounded="square" slides={newArrivals} />
    </TabsContent>
  );
};

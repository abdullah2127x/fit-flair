...
const Popular = () => {
  const [popularProducts, setPopularProducts] = useState<LatestProductsType[]>(
    []
  );
  ...
  return (
    <TabsContent value="popular" className="flex flex-col gap-y-6 items-center">
      <SubTitle>Popular products just for you.</SubTitle>
      <ProductGrid rounded="square" slides={popularProducts} />
    </TabsContent>
  );
};

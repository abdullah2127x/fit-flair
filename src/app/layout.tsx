...
// @ts-ignore - side-effect global CSS import has no module declaration
import "./globals.css";
...
export const metadata: Metadata = {
  title: "Fit Flair | Trendy Fashion for Everyone",
  description:
    "Shop the latest fashion collections at Fit Flair — stylish outfits, secure checkout, and fast delivery.",
}
